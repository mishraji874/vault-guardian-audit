...
// @audit-info unsued import! remove it
...
contract VaultShares is ERC4626, IVaultShares, AaveAdapter, UniswapAdapter, ReentrancyGuard {
    ...
    //
    // @audit-info public should not be used it should be makred as external
    // @audit-info why empty block?? it should be removed
     ...
     */
    // // @audit-info public should not be used it should be makred as external5
